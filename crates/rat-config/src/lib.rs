...
pub use model::{
    ArtifactsConfig, ConfigError, DEFAULT_CONFIG_PATH, DEFAULT_GENERATED_HEADER_NAME,
    DEFAULT_GENERATED_TOML_NAME, FieldDef, FoxgloveOutputConfig, GeneratedConfig, GeneratedMeta,
